...
function cambioTema() {
    ...
    if (bol == 0) {
        ...
        document.getElementById("btn17").className = "btn btn-light button2";
        document.getElementById("btn18").className = "btn btn-dark button";
        ...
        document.getElementById("btn17").className = "btn btn-dark button";
        document.getElementById("btn18").className = "btn btn-light button2";
...
function resultado() {
    ...
    textoArea = document.getElementById("res2").value;
    numeroCaracteres = textoArea.length;
    if (numeroCaracteres >= 13) {
        input1.style.fontSize = "24px";
    } else {
...
function borrar() {
    var input1 = document.getElementById("res");
    var valor = input1.value;
    var dato = valor.substring(0, valor.length - 1);
    input1.value = dato;
    auxResultado();
}
